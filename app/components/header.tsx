        ...
        <header>
            <nav className='max-w-3xl mx-auto border-b py-8 sticky top-0 bg-slate-900'>
                <div className='flex justify-between items-end'>
                    <div>
                        <h1 className='text-4xl font-black bg-clip-text text-transparent bg-linear-to-r from-pink-400  to-violet-400'>Vikas Bhavsar</h1>
                        <p className='font-semibold'>Web Developer</p>
                    </div>
                    <div>
                        <div className='space-x-2'>
                            <a href='mailto:vikasbhvsr@gmail.com' title='Email Me!' className='btn-email p-1 bg-yellow-300 rounded-sm inline-block '>
                            ...
                            <a title='My GitHub link' href='https://github.com/vikasbhvsr' target='_blank' className='btn-github p-1 bg-yellow-300 rounded-sm inline-block'>
                            ...
                            <a className='btn-linkedin p-1 bg-yellow-300 rounded-sm inline-block'>
